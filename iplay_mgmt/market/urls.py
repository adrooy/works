...
urlpatterns = patterns('',
    ...
    url(r'^iplay_mgmt/market/recommend_editGame/$', 'market.recommend.editGame', name='editGame recommend'),
    url(r'^iplay_mgmt/market/recommend_altGame/$', 'market.recommend.altGame', name='altGame recommend'),
    url(r'^iplay_mgmt/market/recommend_isenabledGame/$', 'market.recommend.isenabledGame', name='isenabledGame recommend'),
    url(r'^iplay_mgmt/market/recommend_notenabledGame/$', 'market.recommend.notenabledGame', name='notenabledGame recommend'),
    ...
    url(r'^iplay_mgmt/market/check/$', 'market.topic.check', name='check topic'),
    ...
    url(r'^iplay_mgmt/market/category_alterGame/$', 'market.category.alterGame', name='alterGame category'),
    url(r'^iplay_mgmt/market/category_isenabledGame/$', 'market.category.isenabledGame', name='isenabledGame category'),
    url(r'^iplay_mgmt/market/category_notenabledGame/$', 'market.category.notenabledGame', name='notenabledGame category'),
