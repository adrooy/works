...
ALLOWED_HOSTS = [u'192.168.1.15', u'localhost', u'127.0.0.1']
...
ROOT_URLCONF = 'permission_suggest_management.urls'

WSGI_APPLICATION = 'permission_suggest_management.wsgi.application'
...
#Home page url
INDEX_URL = 'http://192.168.1.45:8900'
# INDEX_URL = 'http://localhost'

#the database of user_message,user_feedback
