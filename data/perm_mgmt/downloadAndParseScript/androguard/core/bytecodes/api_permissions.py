...
"PACKAGE_INFO" : {
    "Landroid/content/pm/PackageManager;" : [
        ("F", "getApplicationInfo", "(Ljava/lang/String; I)"),
        ("F", "getPackageInfo", "(Ljava/lang/String; I)"),
        ("F", "getInstalledApplications", "(I)"),
        ("F", "getInstalledPackages", "(I)"),
...
"MODIFY_AUDIO_SETTINGS" : {
	...
	"Landroid/media/IAudioService$Stub$Proxy;" : [
		...
		# ("F", "setMode", "(I Landroid/os/IBinder;)"), ZZ move to "CALL_MONITOR"
	...
	"Landroid/media/AudioManager;" : [
		...
		# ("F", "setMode", "(I)"), ZZ move to "CALL_MONITOR"
...
"READ_PHONE_STATE" : {
	...
	"Landroid/telephony/TelephonyManager;" : [
		# ("C", "ACTION_PHONE_STATE_CHANGED", "Ljava/lang/String;"), ZZ move this to "CALL_STATE"
		("F", "getDeviceId", "()"),
		...
		("F", "getVoiceMailAlphaTag", "()"),
		("F", "getVoiceMailNumber", "()"),
		# ("F", "listen", "(Landroid/telephony/PhoneStateListener; I)"), ZZ move to "CALL_MONITOR"
	],
	# "Lcom/android/internal/telephony/ITelephonyRegistry$Stub$Proxy;" : [
	# 	("F", "listen", "(Ljava/lang/String; Lcom/android/internal/telephony/IPhoneStateListener; I B)"),
	# ], ZZ move to "CALL_MONITOR"
	"Landroid/telephony/PhoneNumberUtils;" : [
...
#ZZ add "CALL_STATE" & "CALL_MONITOR"
"CALL_STATE" : {
    "Lcom/android/internal/telephony/ITelephony$Stub$Proxy;" : [
		("F", "getCallState", "()"),
    ],
    ...
    "Lcom/android/internal/telephony/IPhoneStateListener$Stub$Proxy;" : [
		("F", "onCallStateChanged", "(I Ljava/lang/String;)"),
    ],
    "Landroid/telephony/PhoneStateListener;" : [
        ("F", "onCallStateChanged", "(I Ljava/lang/String;)"),
    ],
...
"CALL_MONITOR": {
    ...
    "Landroid/media/IAudioService$Stub$Proxy;" : [
        ...
        ("F", "adjustStreamVolume", "(I I I)"),
        ("F", "adjustStreamVolume", "(I I I Ljava/lang/String;)"),
        ("F", "setStreamMute", "(I B Landroid/os/IBinder;)"),
        ("F", "setStreamSolo", "(I B Landroid/os/IBinder;)"),
        ("F", "setStreamVolume", "(I I I)"),
	],
	"Landroid/media/AudioService;" : [
		("F", "setMode", "(I Landroid/os/IBinder;)"),
        ("F", "adjustStreamVolume", "(I I I)"),
...
DVM_PERMISSIONS_BY_ELEMENT = {
	...
	# "Landroid/media/IAudioService$Stub$Proxy;-setMode-(I Landroid/os/IBinder;)" : "MODIFY_AUDIO_SETTINGS", ZZ move to "CALL_MONITOR"
	...
	# "Landroid/media/AudioService;-setMode-(I Landroid/os/IBinder;)" : "MODIFY_AUDIO_SETTINGS", ZZ move to "CALL_MONITOR"
	...
	# "Landroid/media/AudioManager;-setMode-(I)" : "MODIFY_AUDIO_SETTINGS", ZZ move to "CALL_MONITOR"
	...
	# "Landroid/telephony/TelephonyManager;-ACTION_PHONE_STATE_CHANGED-Ljava/lang/String;" : "READ_PHONE_STATE", ZZ move this to "CALL_STATE" as following line
    "Landroid/telephony/TelephonyManager;-ACTION_PHONE_STATE_CHANGED-Ljava/lang/String;" : "CALL_STATE",
	...
	# "Landroid/telephony/TelephonyManager;-getDeviceId-()" : "READ_PHONE_STATE", ZZ comment out duplicate line
	# "Landroid/telephony/TelephonyManager;-getDeviceSoftwareVersion-()" : "READ_PHONE_STATE", ZZ comment out duplicate line
	"Landroid/telephony/TelephonyManager;-getLine1AlphaTag-()" : "READ_PHONE_STATE",
	# "Landroid/telephony/TelephonyManager;-getLine1Number-()" : "READ_PHONE_STATE", ZZ comment out duplicate line
	# "Landroid/telephony/TelephonyManager;-getSimSerialNumber-()" : "READ_PHONE_STATE", ZZ comment out duplicate line
	# "Landroid/telephony/TelephonyManager;-getSubscriberId-()" : "READ_PHONE_STATE", ZZ comment out duplicate line
	# "Landroid/telephony/TelephonyManager;-getVoiceMailAlphaTag-()" : "READ_PHONE_STATE", ZZ comment out duplicate line
	# "Landroid/telephony/TelephonyManager;-getVoiceMailNumber-()" : "READ_PHONE_STATE", ZZ comment out duplicate line
	# "Landroid/telephony/TelephonyManager;-listen-(Landroid/telephony/PhoneStateListener; I)" : "READ_PHONE_STATE", ZZ move to "CALL_MONITOR"
	# "Lcom/android/internal/telephony/ITelephonyRegistry$Stub$Proxy;-listen-(Ljava/lang/String; Lcom/android/internal/telephony/IPhoneStateListener; I B)" : "READ_PHONE_STATE", ZZ move to "CALL_MONITOR"
    ...
    "Lcom/android/internal/telephony/ITelephony$Stub$Proxy;-getCallState-()" : "CALL_STATE",
    "Landroid/telephony/TelephonyManager;-getCallState-()" : "CALL_STATE",
    "Lcom/android/internal/telephony/IPhoneStateListener$Stub$Proxy;-onCallStateChanged-(I Ljava/lang/String;)" : "CALL_STATE",
    "Landroid/telephony/PhoneStateListener;-onCallStateChanged-(I Ljava/lang/String;)" : "CALL_STATE",
    "Lcom/android/internal/telephony/ITelephonyRegistry$Stub$Proxy;-listen-(Ljava/lang/String; Lcom/android/internal/telephony/IPhoneStateListener; I B)" : "CALL_MONITOR",
    "Landroid/telephony/TelephonyManager;-listen-(Landroid/telephony/PhoneStateListener; I)" : "CALL_MONITOR",
    "Landroid/media/IAudioService$Stub$Proxy;-setMode-(I Landroid/os/IBinder;)" : "CALL_MONITOR",
    "Landroid/media/IAudioService$Stub$Proxy;-adjustStreamVolume-(I I I)" : "CALL_MONITOR",
    "Landroid/media/IAudioService$Stub$Proxy;-adjustStreamVolume-(I I I Ljava/lang/String;)" : "CALL_MONITOR",
    "Landroid/media/IAudioService$Stub$Proxy;-setStreamMute-(I B Landroid/os/IBinder;)" : "CALL_MONITOR",
    "Landroid/media/IAudioService$Stub$Proxy;-setStreamSolo-(I B Landroid/os/IBinder;)" : "CALL_MONITOR",
    "Landroid/media/IAudioService$Stub$Proxy;-setStreamVolume-(I I I)" : "CALL_MONITOR",
	"Landroid/media/AudioService;-setMode-(I Landroid/os/IBinder;)" : "CALL_MONITOR",
    "Landroid/media/AudioService;-adjustStreamVolume-(I I I)" : "CALL_MONITOR",
    "Landroid/media/AudioService;-adjustStreamVolume-(I I I Ljava/lang/String;)" : "CALL_MONITOR",
    "Landroid/media/AudioService;-setStreamMute-(I B Landroid/os/IBinder;)" : "CALL_MONITOR",
    "Landroid/media/AudioService;-setStreamSolo-(I B Landroid/os/IBinder;)" : "CALL_MONITOR",
    "Landroid/media/AudioService;-setStreamVolume-(I I I)" : "CALL_MONITOR",
    "Landroid/media/AudioManager;-setMode-(I)" : "CALL_MONITOR",
    "Landroid/media/AudioManager;-adjustStreamVolume-(I I I)" : "CALL_MONITOR",
    "Landroid/media/AudioManager;-setStreamMute-(I B)" : "CALL_MONITOR",
    "Landroid/media/AudioManager;-setStreamSolo-(I B)" : "CALL_MONITOR",
    "Landroid/media/AudioManager;-setStreamVolume-(I I I)" : "CALL_MONITOR",
    ...
    "Landroid/content/pm/PackageManager;-getApplicationInfo-(Ljava/lang/String; I)" : "PACKAGE_INFO",
    "Landroid/content/pm/PackageManager;-getPackageInfo-(Ljava/lang/String; I)" : "PACKAGE_INFO",
    "Landroid/content/pm/PackageManager;-getInstalledApplications-(I)" : "PACKAGE_INFO",
    "Landroid/content/pm/PackageManager;-getInstalledPackages-(I)" : "PACKAGE_INFO",
}