        ...
        for i in self.zip.namelist():
            if i == "AndroidManifest.xml":
                ...
                if self.xml[i] != None:
                    ...
                    #print self.package,self.androidversion["Code"],self.androidversion["Name"]
                    #print self.xml[i].getElementsByTagName('uses-permission')
                    #sys.exit()
